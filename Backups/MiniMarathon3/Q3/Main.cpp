...
int main()
{
    ...
    try{
        ...
        std::cout<<"Fuel tank capacity is above 30 or not "<<std::boolalpha<<TankCap.get();
        ...
        //Getting the evcars
        float f = 35;
        std::future<EVCarContainer> cont = std::async(BatteryThreshold, std::ref(data), std::ref(f));
        cont.get();
